...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>alert('A reset link has been sent to your email address.'); window.location.href='../../html/employer/login_employer.html';</script>";
    } else {
        echo "<script>alert('No account found with that email address.'); window.location.href='../../html/employer/login_employer.html';</script>";
    }
